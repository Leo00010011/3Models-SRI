...
{
    public WMDocTerm(ICollection<IDocument> corpus) => Storage = new VSMStorageDT(corpus);
...
{
    public VSMDocTerm(ICollection<IDocument> corpus) : base(corpus) { }
...
{
    public WMTermDoc(ICollection<IDocument> corpus) => Storage = new VSMStorageTD(corpus);
...
{
    public VSMTermDoc(ICollection<IDocument> corpus) : base(corpus) { }
...
{
    public GVSMTermDoc(ICollection<IDocument> corpus) : base(corpus) => Storage = new GVSMStorageDT(corpus);
...
public class BSMTermDoc : WMTermDoc, ISRIModel<string, string, string, int, IDocument>, ICollection<IDocument>
{
    ...
    public BSMTermDoc(ICollection<IDocument> corpus) : base(corpus) { }
